# -*- encoding: utf-8 -*-
# stub: cucumber-messages 32.3.1 ruby lib

Gem::Specification.new do |s|
  s.name = "cucumber-messages".freeze
  s.version = "32.3.1".freeze
  ...
  s.summary = "cucumber-messages-32.3.1".freeze
  ...
  s.add_development_dependency(%q<rubocop-rspec>.freeze, ["~> 3.7.0".freeze])
end
