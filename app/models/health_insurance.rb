class HealthInsurance < ApplicationRecord
  ...
  # calling total_documents_count per row on listing pages (was up to 5
  # separate queries per policy: 2 Active Storage checks, uploaded_documents,
  # policy_documents_records, health_insurance_documents).
