# InsureBook Mobile API Testing Guide

This comprehensive guide provides step-by-step instructions for testing all InsureBook Mobile API endpoints using various tools and methods.
...
2. **Import Collection**
   - Open Postman
   - Click "Import" button
   - Choose the file: `InsureBook_Mobile_API.postman_collection.json`
   - Click "Import"

3. **Create Environment**
   - Click on "Environments" in left sidebar
   - Click "Create Environment"
   - Name: "InsureBook Mobile API - Local"
   - Add variables:
     ```
     Variable: base_url
...
```bash
# Start Rails server
cd /home/mahadev-bhat/Desktop/work2/insurebook_admin
...
2. Select "InsureBook Mobile API" collection
3. Set iterations: 10
4. Set delay: 100ms
5. Run collection
...
# Run collection
newman run InsureBook_Mobile_API.postman_collection.json \
  -e InsureBook_Mobile_API_Local.postman_environment.json \
  --reporters cli,html \
...
This testing guide provides comprehensive coverage for testing the InsureBook Mobile API. Follow the steps systematically to ensure all endpoints work correctly and handle error cases appropriately.