...
# before_save :add_country_code_to_mobile # Commented out - frontend already shows +91
  ...
  # Every affiliate gets the signup bonus in their INACTIVE wallet once KYC is
  # approved, whether or not they signed up with a referral code. Idempotent
  # (approving twice never double-credits), and a wallet problem must never
  # undo the approval itself.
