...
ActiveRecord::Schema[8.0].define(version: 2026_01_13_155910) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean "password_reset_required", default: false, null: false, comment: "Whether user needs to reset password"
    t.datetime "password_reset_expires_at", comment: "When current password expires (180 days from reset)"
    t.index ["password_reset_expires_at"], name: "index_users_on_password_reset_expires_at"
    t.index ["password_reset_required"], name: "index_users_on_password_reset_required"
