...
admin_user = create_or_update_user('admin@insurebook.com', {
  first_name: 'Admin',
  last_name: 'User',
...
agent_user = create_or_update_user('subagent@insurebook.com', {
  first_name: 'Rajesh',
  last_name: 'Kumar',
...
puts "Agent: subagent@insurebook.com / subagent123456"
