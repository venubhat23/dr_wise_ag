...
admins = 5.times.map do |i|
  User.create!(
    ...
    email: "admin#{existing_admin_count + i + 1}@insurebook.com",
...
agents = 20.times.map do |i|
  User.create!(
    ...
    email: "agent#{existing_agent_count + i + 1}@insurebook.com",
    password: 'password123',
    mobile: random_mobile,
    user_type: 'agent',
    role: 'agent_role',
...
customers_users = 25.times.map do |i|
  User.create!(
    first_name: FIRST_NAMES[i % FIRST_NAMES.length],
    last_name: LAST_NAMES[i % LAST_NAMES.length],
    email: "customer#{existing_customer_count + i + 1}@insurebook.com",
    password: 'password123',
    mobile: random_mobile,
    user_type: 'customer',
    role: 'user_role',
...
distributors = 15.times.map do |i|
  ...
  Distributor.create!(
    ...
    mobile: random_mobile,
    email: "dist#{existing_distributor_count + i + 1}@insurebook.com",
    pan_no: random_pan,
...
sub_agents = 40.times.map do |i|
  ...
  SubAgent.create!(
    ...
    last_name: name_parts[1],
    mobile: random_mobile,
    email: "subagent#{existing_subagent_count + i + 1}@insurebook.com",
    pan_no: random_pan,
    aadhar_no: rand(100000000000..999999999999).to_s,
...
investors = 20.times.map do |i|
  ...
  Investor.create!(
    ...
    last_name: name_parts[1],
    mobile: random_mobile,
    email: "investor#{existing_investor_count + i + 1}@insurebook.com",
...
puts "="*40
puts "Admin User:"
puts "Email: admin1@insurebook.com"
