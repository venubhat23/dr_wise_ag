# -*- encoding: utf-8 -*-
# stub: cucumber-core 16.2.0 ruby lib

Gem::Specification.new do |s|
  s.name = "cucumber-core".freeze
  s.version = "16.2.0".freeze
  ...
  s.summary = "cucumber-core-16.2.0".freeze

  s.installed_by_version = "3.7.1".freeze

  s.specification_version = 4

  s.add_runtime_dependency(%q<cucumber-gherkin>.freeze, ["> 36".freeze, "< 40".freeze])
  s.add_runtime_dependency(%q<cucumber-messages>.freeze, ["> 31".freeze, "< 33".freeze])
  s.add_runtime_dependency(%q<cucumber-tag-expressions>.freeze, ["> 6".freeze, "< 9".freeze])
  s.add_development_dependency(%q<rake>.freeze, ["~> 13.3".freeze])
  s.add_development_dependency(%q<rspec>.freeze, ["~> 3.13".freeze])
  s.add_development_dependency(%q<rubocop>.freeze, ["~> 1.81.0".freeze])
  ...
  s.add_development_dependency(%q<rubocop-rspec>.freeze, ["~> 3.8.0".freeze])
end
