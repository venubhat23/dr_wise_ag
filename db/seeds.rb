...
# Create Admin User
admin = User.find_or_create_by!(email: "admin@insurebook.in") do |user|
...
# Create some Agents
agents_data = [
  { first_name: "Rajesh", last_name: "Kumar", email: "rajesh@insurebook.in", mobile: "9876543211" },
  { first_name: "Priya", last_name: "Sharma", email: "priya@insurebook.in", mobile: "9876543212" },
  { first_name: "Amit", last_name: "Patel", email: "amit@insurebook.in", mobile: "9876543213" }
]
...
puts "Admin Login: admin@insurebook.in / password"
