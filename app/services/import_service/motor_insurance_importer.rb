...
module ImportService
  class MotorInsuranceImporter
    ...
    def process_row(row, row_number)
      ...
      # Prepare motor insurance data
      motor_insurance_data = prepare_motor_insurance_data(insurance_data, customer, sub_agent)

      motor_insurance = MotorInsurance.new(motor_insurance_data)
    ...
    def normalize_insurance_data(row)
      {
        ...
        vehicle_type: row['vehicle_type']&.to_s&.strip || 'New Vehicle',
    ...
    def prepare_motor_insurance_data(insurance_data, customer, sub_agent)
