...
ActiveRecord::Schema[8.0].define(version: 2026_03_27_155233) do
  ...
  create_table "insurance_companies", force: :cascade do |t|
    ...
    t.index ["insurance_type", "status"], name: "idx_insurance_companies_type_status"
    t.index ["insurance_type"], name: "idx_insurance_companies_type"
    ...
    t.index ["status", "insurance_type"], name: "idx_insurance_companies_status_type"
  ...
  create_table "motor_insurances", id: :serial, force: :cascade do |t|
    ...
    t.decimal "main_agent_tds_percentage", precision: 8, scale: 2
