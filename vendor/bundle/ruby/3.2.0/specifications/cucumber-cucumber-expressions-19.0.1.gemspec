# -*- encoding: utf-8 -*-
# stub: cucumber-cucumber-expressions 19.0.1 ruby lib

Gem::Specification.new do |s|
  s.name = "cucumber-cucumber-expressions".freeze
  s.version = "19.0.1".freeze
  ...
  s.summary = "cucumber-expressions-19.0.1".freeze
  ...
  s.add_development_dependency(%q<rubocop>.freeze, ["~> 1.55.0".freeze])
  ...
  s.add_development_dependency(%q<rubocop-rspec>.freeze, ["~> 3.0.0".freeze])
end
