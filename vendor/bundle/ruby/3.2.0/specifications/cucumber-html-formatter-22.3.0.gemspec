# -*- encoding: utf-8 -*-
# stub: cucumber-html-formatter 22.3.0 ruby lib

Gem::Specification.new do |s|
  s.name = "cucumber-html-formatter".freeze
  s.version = "22.3.0".freeze
  ...
  s.summary = "cucumber-html-formatter-22.3.0".freeze

  s.installed_by_version = "3.7.1".freeze

  s.specification_version = 4

  s.add_runtime_dependency(%q<cucumber-messages>.freeze, ["> 23".freeze, "< 33".freeze])
